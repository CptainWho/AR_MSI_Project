...
carrot_donkey = CarrotDonkey.CarrotDonkey(myRobot, myWorld, robot_loc)
...
polylines = path_sched.find_shortest_route(robot_loc.get_robot_point())

print path_sched.debug_length
print path_sched.shortest_route_length

complete_path = []
for polyline in polylines:
    poly = Calc.douglas_peucker(polyline, 0.2)
    complete_path.extend(poly)
#print complete_path

myWorld.drawPolyline(complete_path)
